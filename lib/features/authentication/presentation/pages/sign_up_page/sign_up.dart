...
// // import 'package:productive_new_version/features/authentication/presentation/pages/sign_up_page/sign_up_bloc/sign_up_bloc.dart';
...
// //                   controller:
// //                   context.read<SignUpBloc>().mailTextEditingController,
...
// //                   controller:
// //                   context.read<SignUpBloc>().passwordTextEditingController,
...
// //                           context.watch<SignUpBloc>().state.isObscure
// //                               ? AppIcons.eyeOff
// //                               : AppIcons.eyeOn,
// //                         ),
// //                       ),
...
// //                   onTap: () {
// //                     context.read<SignUpBloc>().add(SignUpButtonPressedEvent(context));
// //                   },
// //                   child: WButton(
                  ...
                  onTap: () async {
                    try {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            "Ushbu user foydalanilgan. Qayta urunib ko'ring.",
